        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow(Icons.location_on, "Location", widget.venue, isDarkMode),
              _buildDetailRow(Icons.people, "Attendees", widget.attendees.toString(), isDarkMode),
              _buildDetailRow(Icons.category, "Category", widget.club, isDarkMode),

              const SizedBox(height: 16),

              // ✅ Organizer Info
              _buildSectionHeader("Organizer", isDarkMode),
              _buildDetailRow(Icons.person, "Organizer", widget.organizer, isDarkMode),
              _buildDetailRow(Icons.phone, "Contact", widget.contact, isDarkMode),
              _buildDetailRow(Icons.public, "Website", widget.website, isDarkMode),
